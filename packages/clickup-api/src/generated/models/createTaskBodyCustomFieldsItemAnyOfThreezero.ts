 ...
 */
import type { CreateTaskBodyCustomFieldsItemAnyOfThreezeroValue } from './createTaskBodyCustomFieldsItemAnyOfThreezeroValue';

/**
 * Set a button Custom Field to `true` to "click" it. This will trigger the button's action as if it was clicked in the UI.
 */
export type CreateTaskBodyCustomFieldsItemAnyOfThreezero = {
  id: string;
  value: CreateTaskBodyCustomFieldsItemAnyOfThreezeroValue;
};
